# Writ V5 — canonical deploy manifest (botchain-test)
...
| Contract | Package hash | Contract hash | Install tx | Gas (BOT) |
|---|---|---|---|---|
...
| writ_registry_filter (ERC-721 hook) | `hash-0b1f806b13712752c6740890cb9fae33aa782d47b1c858564d97248c43407fb5` | `hash-5254fa90d7fae22ae427f96a458370074a55fe86ce15d15810562ffea459a047` | [`8c2766e2`](https://testnet.cspr.live/deploy/8c2766e246c9ef3758c726610964176510b9826ee771af854b57d8ffaa5d7d5b) | 88.2 |
| transfer-filter (Solidity) | `hash-30cca9f1242679e7396b9a39ad2c087c7a30b1b4848cfb2324bbd4034976d469` | `hash-f8c6f324fe5a0407aef252f25da54868066d40e12f689d59a0d7a5d7f656b4e2` | [`b9223f83`](https://testnet.cspr.live/deploy/b9223f839cd213b90ce1d0332f3c937953af8cecca877e039ed5ed4eda8fc680) | 225.8 |
...
| `grant_challenge` | [`8cc68bdd`](https://testnet.cspr.live/deploy/8cc68bdd617efd7eb83cac6389c2caf98f38deead92be3942ef77a520520fff1) | CHALLENGE_ROLE → the challenge **package** (Solidity addresses contracts by package hash) |
...
| attestor bond q1 | [`818c6763`](https://testnet.cspr.live/deploy/818c6763032bb6a9b8d8a56faabda159db79498bd90ad3664f9ef066a75cc368) | 250 BOT, payable via cargo-purse recipe |
| attestor bond q2 | [`6e648cdb`](https://testnet.cspr.live/deploy/6e648cdb824af49f0e647cfb156a3c7273f7fe7ea36974a34db8567693a6ee54) | 250 BOT |

### The payable-call workaround (unchanged from V4, still required)

Solidity `#[payable]` entrypoints (`challenge.bond`, `challenge.challenge`) cannot be
...
Fraud challenge filed: [`dcdf20e5`](https://testnet.cspr.live/deploy/dcdf20e5790c67d341f28ef7abb9865598f6e3ddc4f6249c6800179c65ee375b) (250 BOT bond, payable).
...
| **Treasury transfer** (NOT a burn) | 500 − 390 = 110 | treasury 224.6 → 334.6 BOT |
| Resolve gas (on-chain pairing verify) | ~80–95 | 95.1 BOT consumed |
...
Redeploying from scratch (needs ~2,000 BOT liquid):
