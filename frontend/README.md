...
The Vritz web app. **Anu's PRs land here.** Next.js (App Router, TypeScript, Tailwind), scaffolded so the first PR is features, not boilerplate.
...
app/globals.css       Vritz design tokens (Tailwind v4 @theme)
```
