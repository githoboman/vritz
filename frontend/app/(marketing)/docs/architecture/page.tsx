  ...
  return (
    ...
    >
      <ul className="space-y-2.5 text-[15px]">
        ...
        <Contract pkg={CONTRACTS.cep78.pkg} name="Vritz CEP-78" job="the RWA bond NFT (real CEP-78), wired to the filter and mint-gated." />
        <Contract pkg={CONTRACTS.token.pkg} name="Vritz Token" job="the Vritz-token and its Odra transfer filter." />
      </ul>
