...
export default function DocsProblem() {
  return (
    <DocArticle
      ...
      description="Two failures block institutions from tokenizing regulated assets. Vritz removes both."
    >
      ...
      <p>
        Vritz keeps the compliance and throws away the honeypot: the issuer holds{" "}
